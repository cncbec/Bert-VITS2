...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-m", "--model", default="./logs/gxd/G_5000.pth", help="path of your model"
    )
    parser.add_argument(
        "-c",
        "--config",
    ...
    parser.add_argument(
        "-s", "--speaker", default="gxd", action="store_true", help="speaker short name"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--length_scale", default=1, action="store_true", help="length scale" #minimum=0.1, maximum=2
    )
    parser.add_argument(
